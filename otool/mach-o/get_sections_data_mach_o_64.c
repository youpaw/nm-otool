...
static void	get_sect_data(t_sect_data *sect_data, struct section_64 *section, \
	char swap)
{
	...
	if (swap)
	{
		sect_data->addr = ft_swap_uint64(section->addr);
		sect_data->size = ft_swap_uint64(section->size);
